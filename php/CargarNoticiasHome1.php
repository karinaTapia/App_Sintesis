...
$html.='<!--Slide Principal-->
	...
	';
	$select_app="SELECT * FROM app_articulos WHERE posicion='Slide-Principal' AND estatus='1' ORDER BY id DESC LIMIT 5 ";
...
$select_app="SELECT * FROM app_articulos WHERE posicion='Slide-Miniaturas' AND estatus='1' ORDER BY id DESC LIMIT 0,3 ";
$r_app=mysql_query($select_app,$conexion);
while($f_app=mysql_fetch_assoc($r_app)):
	$id_nota_app=$f_app['id'];
	$id_articulo_app=$f_app['id_articulo'];
...
$html.='<div class="panelSwipe SubContenedorSlideMiniaturas">
		...
		<div class="panelSwipe SubContenedorSlideMiniaturas">
				<a href="#nota" onclick="LeerNota('.$id_nota_app.')">
					<div class="SubContenedorSlideMiniaturas">
					  <div class="SlideMiniaturasImagen"><img src="'.$url_dominio_.'/images/imagenes-articulos/'.$imagen.'"></div>
					  <div class="SlideMiniaturasContenido">
...
<!--Slide Miniaturas--> 
    ...
    <!--Slide Vertical-->
    <div class="ContenedorSlideVertical simple-vertical">
		<div >';
...
$select_appMin="SELECT id FROM app_articulos WHERE posicion='Slide-Vertical' AND estatus='1' ORDER BY id DESC LIMIT 3,3 ";
...
$html.='<div >';
	...
	$select_app="SELECT * FROM app_articulos WHERE posicion='Slide-Vertical' AND estatus='1' ORDER BY id DESC LIMIT 3,3 ";
$r_app=mysql_query($select_app,$conexion);
while($f_app=mysql_fetch_assoc($r_app)):
	$id_nota_app=$f_app['id'];
	$id_articulo_app=$f_app['id_articulo'];
