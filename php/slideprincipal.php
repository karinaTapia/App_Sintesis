...
$select_app="SELECT * FROM app_articulos WHERE posicion='Slide-Principal' AND estatus='1' ORDER BY id DESC limit 3";
	...
	if(isset($_POST['accion'])){
		if($_POST['accion'] == 'leer'){
			...
			while($res = mysql_fetch_array($r_app)){
				$arr[$i] = array(
					'id' => $res['id'],
					'dat1' => $res['id_articulo'],
					'dat2' => $res['plaza'],
				);
				$i++;
			}
